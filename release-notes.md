...
The application processes property photos locally, applies the Alpha branding frame, outputs `1200x1000` WebP images, supports previews and ZIP export, and uses native WPF/XAML UI.
